...
module.exports =  {
    ...
    calculatePos(gameObjects, oldCoord){
        ...
        result.tact = gameObjects.shift(); // удаляем первый элемент массива (номер такта)
        ...
        // координаты мяча
        if (result.ball)
        result.ball.pos = this.calculateObjectCoord(flagsNearMyself, myselfCoord, result.ball.dist)
